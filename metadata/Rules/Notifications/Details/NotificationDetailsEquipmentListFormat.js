export default function NotificationDetailsEquipmentListFormat(context) {
    ...
    return context.read('/SAPAssetManager/Services/AssetManager.service', `MyEquipments('${binding}')`, [], '$select=EquipDesc,EquipId,Manufacturer,ModelNum,ObjectStatus_Nav/SystemStatus_Nav/StatusText&$expand=ObjectStatus_Nav/SystemStatus_Nav').then(function(data) {
