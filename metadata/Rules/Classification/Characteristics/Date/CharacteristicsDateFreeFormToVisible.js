...
export default function CharacteristicsDateFreeFormToVisible(formCellContainerProxy) {
    ...
    if (singleValue === 'X' && dataType === 'DATE' && freeForm(formCellContainerProxy) && valueCode.includes(valueRelation)) {
