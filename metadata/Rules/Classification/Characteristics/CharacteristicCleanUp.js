...
export default function CharacteristicCleanUp(pageProxy) {
    ...
    libCommon.clearFromClientData(pageProxy, ['VisibleControlTo', 'VisibleControlFrom','ListPicker', 'MultiListPicker', 'MultiListPickerCurrentIndex', 'ListPickerLoopIndex', 'CharValCountIndex', 'ClassCharValues', 'ListPickerDeleteIndex','isDeleting', 'CurrentLocalReadLink']);
}
