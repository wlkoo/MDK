...
export default function CharacteristicCurrencyFreeFormToVisible(formCellContainerProxy) {
    ...
    if (singleValue === 'X' && dataType === 'CURR' && freeForm(formCellContainerProxy) && valueCode.includes(valueRelation)) {
