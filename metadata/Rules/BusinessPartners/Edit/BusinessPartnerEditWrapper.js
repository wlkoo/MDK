...
export class BusinessPartnerEditWrapper extends BusinessPartnerWrapper {
    ...
    editCommPropertyActionData(property) {
        ...
        if (entity === null) {
            // Add client data properties for a create action
            // Using create instead of add because of *Add*ress
            let actionParts = action.split('/');
            let last = actionParts.pop();
            last = last.replace('Edit', 'Create');
            actionParts.push(last);
