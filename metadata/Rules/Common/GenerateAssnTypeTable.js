...
export default function GenerateAssnTypeTable(context,type) {
    ...
    switch (type) {
        case 'WorkOrder':
            ...
            //TODO need work center plant's param name, waiting for cascading logic from SEAM
            //fieldparams.WorkCenterPlant.default = GlobalVar.getUserSystemInfo().get('USER_PARAM.IWK'); 
